...
export default function HeadlineHorizontalLoop({
    texts = ['DIA 24 E 25 DE ABRIL DE 2026', 'DIA 24 E 25 DE ABRIL DE 2026', 'DIA 24 E 25 DE ABRIL DE 2026' , 'DIA 24 E 25 DE ABRIL DE 2026' , 'DIA 24 E 25 DE ABRIL DE 2026'],
    speed = 'normal',
    customDuration,
}: HeadlineLoopProps) {
